...
public class EnglishCheckTextTest extends BaseTest {
    ...
    public void oneWordWithMistake(String[] data){
        ...
        SpellerAssertions result = new SpellerAssertions(service.spellerGetTextWithLang(CHECK_TEXT_URI, LANG, data));
    ...
    public void ignoringURLs(String[] data){
        RestService service = new RestService();
        SpellerAssertions result = new SpellerAssertions(service.spellerGetTextWithOptions(CHECK_TEXT_URI, IGNORE_URLS, new String[]{data[0]}));
